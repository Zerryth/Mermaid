...
![AuthenticationDocExample_TheActualFlow](../../GraphSVGs/AuthenticationDocExample_TheActualFlow.svg "AuthenticationDocExample - The Actual Flow")

* Consider: removing Bot Framework Channel participant and only illustrate the interaction

<details>
    <summary>Sequence diagrams following the Authentication docs verbatim</summary>
...
* Also, does the User sign into the External Service directly? Or just the Authorization Server that the External Service trusts? (I believed it to be the latter, just from my reading on OAuth concepts in general, outside BF...)
...
* Ok, I'm pretty convinced our [Authentication](https://docs.microsoft.com/en-us/azure/bot-service/bot-builder-concept-authentication?view=azure-bot-service-4.0) documentation is incorrect
* See [video on OAuth 2.0 concepts](https://www.youtube.com/watch?v=CPbvxxslDTU)
* I also have been reading [OAuth 2.0 in Action](https://www.manning.com/books/oauth-2-in-action), which also says you sign into the Authorization Server, *not* the Protected Resource (External Service)
</details>
